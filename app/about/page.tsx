...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    'Pacific Water Tanks — Australian-owned water storage engineering specialists since 2013. 20+ years combined expertise, zero injury record, nationwide coverage.',
}
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-[#0d1b2a] via-[#30505b] to-[#3e91ce] pt-40 pb-24">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-[#3e91ce] text-xs font-bold tracking-widest uppercase mb-4">/ About Pacific Water Tanks</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Pacific Water Tanks was founded in 2013 with a single purpose: to deliver engineered water storage solutions that genuinely meet the demands of Australia's most challenging projects. We are not a product supplier with an installation team. We are an engineering-led organisation that designs, builds, inspects, and maintains water storage infrastructure for the long term.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
      ...
      <section className="bg-[#F4F6F8] py-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            {[
              { year: '2013', label: 'Founded', desc: 'Pacific Water Tanks established with a focus on engineering-led water storage solutions for demanding projects.' },
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Michael founded Pacific Water Tanks in 2013 and has led every significant project delivery since. As a Senior Project Engineer with deep expertise in water infrastructure, Michael brings a hands-on engineering approach to every client engagement — from initial project consultation through to final commissioning. His commitment to honest advice, technical rigour, and lasting outcomes defines the Pacific Water Tanks culture.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#0d1b2a] py-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-white">SEVEN REASONS TO CHOOSE PACIFIC WATER TANKS</h2>
          </div>
      ...
      <CTABanner
        ...
        subheading="Schedule a free project consultation with Michael Spiller and the Pacific Water Tanks team."
