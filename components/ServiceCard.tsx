  ...
  return (
    <motion.div whileHover={{ y: -6, scale: 1.02 }} transition={{ duration: 0.3, ease: 'easeOut' }}>
      <Link href={href} className="group block h-full">
        <div className="relative h-full bg-[#1a3049] border border-white/15 rounded-2xl p-6 overflow-hidden card-glow transition-all duration-500 hover:border-[#3e91ce]/60">
